...
- 4 different blog style Layout
- 100 most popular google fonts included
- Unlimited color variation using customizer api
...
You can install the theme through the WordPress installer under "Themes" > "Install themes" by searching for "MarketingBlog Lite".
...
Theme documentation is available on https://themewagon.com/marketingblog
