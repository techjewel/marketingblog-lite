...
<header class="page-header archive_header">
    <h1 class="page-title text-center"><?php printf( esc_html__( 'Search Results for: %s', 'marketingblog-lite' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
</header><!-- .page-header -->
		...
		<div class="main-content-inner col-sm-12 col-md-8 <?php echo $blog_content_css_class; ?>">
			...
			<section id="primary" class="content-area">
				...
				<?php if ( have_posts() ) : ?>
					...
					<?php marketingblog_lite_paging_nav(); ?>
